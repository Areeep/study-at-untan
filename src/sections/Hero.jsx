export default function Hero() {
  return (
    <section className="relative flex h-[40dvh] flex-col justify-center gap-2 bg-[url('/images/hero.png')] bg-cover bg-center px-4 text-white sm:h-[50dvh] sm:gap-4 sm:px-12 md:h-[70dvh] md:gap-6 md:px-16 lg:h-[70dvh] lg:px-24">
